...
/* harmony import */ var modern_normalize__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(404);
/* harmony import */ var _weatherApi_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(526);
/* harmony import */ var _geolocation_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(374);
/* harmony import */ var _weatherPageController_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(826);
...
async function onMyLocationWeatherClicked() {
    try {
        (0,_weatherPageController_js__WEBPACK_IMPORTED_MODULE_1__/* .toggleLoader */ .i1)(true)
        const position = await (0,_geolocation_js__WEBPACK_IMPORTED_MODULE_2__/* ["default"] */ .A)()
        if (position !== null) {
            position.localLocation = true
            displayWeather(position)
        }
    } finally {
        (0,_weatherPageController_js__WEBPACK_IMPORTED_MODULE_1__/* .toggleLoader */ .i1)(false)
    }
}
...
async function displayWeather(location) {
    ...
    try {
        (0,_weatherPageController_js__WEBPACK_IMPORTED_MODULE_1__/* .toggleLoader */ .i1)(true)
        const weatherJson = await (0,_weatherApi_js__WEBPACK_IMPORTED_MODULE_3__/* .fetchWeatherForLocation */ .h)(location)
        console.log(weatherJson)
        if (weatherJson) {
            (0,_weatherPageController_js__WEBPACK_IMPORTED_MODULE_1__/* .displayWeatherDetails */ .v2)(weatherJson, location.localLocation)
        } else {
            (0,_weatherPageController_js__WEBPACK_IMPORTED_MODULE_1__/* .displayLocationNotFound */ .dc)()
        }
    } catch (error) {
        if (error.code === 400) {
            (0,_weatherPageController_js__WEBPACK_IMPORTED_MODULE_1__/* .displayLocationNotFound */ .dc)()
        } else {
            (0,_weatherPageController_js__WEBPACK_IMPORTED_MODULE_1__/* .displayApiError */ .Ps)()
        }
    } finally {
        (0,_weatherPageController_js__WEBPACK_IMPORTED_MODULE_1__/* .toggleLoader */ .i1)(false)
    }
...
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   h: () => (/* binding */ fetchWeatherForLocation)
/* harmony export */ });
...
__webpack_require__.d(__webpack_exports__, {
  Ps: () => (/* binding */ displayApiError),
  dc: () => (/* binding */ displayLocationNotFound),
  v2: () => (/* binding */ displayWeatherDetails),
  i1: () => (/* binding */ toggleLoader)
});
...
;// ./src/videos/rainy_weather.mp4
const rainy_weather_namespaceObject = __webpack_require__.p + "84b23e27e17fd1167e2f.mp4";
;// ./src/videos/hail_weather.mp4
const hail_weather_namespaceObject = __webpack_require__.p + "af268cb7e9e8a56a74e1.mp4";
;// ./src/videos/snow_weather.mp4
const snow_weather_namespaceObject = __webpack_require__.p + "eaa568887e4c12d5ec04.mp4";
;// ./src/videos/cloudy_weather.mp4
const cloudy_weather_namespaceObject = __webpack_require__.p + "db47f4e6f2c79410c6ea.mp4";
;// ./src/videos/clear_weather.mp4
const clear_weather_namespaceObject = __webpack_require__.p + "91047b86f6fe88d80891.mp4";
;// ./src/videos/storm_weather.mp4
const storm_weather_namespaceObject = __webpack_require__.p + "9cc215b1701816f38681.mp4";
;// ./src/videos/fog_weather.mp4
const fog_weather_namespaceObject = __webpack_require__.p + "f4ffbc970fd13b311d08.mp4";
;// ./src/weatherTypes.js
...
const weatherTypeMap = new Map([
    [
        "type_1",
        {
            ...
            videoSrc: snow_weather_namespaceObject,
        },
    ],
    [
        "type_2",
        {
            text: "Drizzle",
            videoSrc: rainy_weather_namespaceObject,
        },
    ],
    [
        "type_3",
    ...
    [
        ...
        {
            text: "Fog",
            videoSrc: fog_weather_namespaceObject,
        },
    ],
    [
        "type_9",
        {
            ...
            videoSrc: hail_weather_namespaceObject,
        },
    ],
    [
        "type_10",
    ...
    [
        "type_15",
        {
            ...
            videoSrc: storm_weather_namespaceObject,
        },
    ],
    [
        "type_16",
    ...
    [
        "type_27",
        {
            ...
            videoSrc: cloudy_weather_namespaceObject,
        },
    ],
    [
        "type_28",
    ...
    [
        ...
        {
            text: "Clear",
            videoSrc: clear_weather_namespaceObject,
        },
    ],
])
...
/* harmony default export */ const weatherTypes = (getWeatherTypeData);
...
function displayWeatherDetails(weatherJson, usedLocalLocation = false) {
    ...
    if (locationConditions) {
        ...
        const { text, videoSrc } = weatherTypes(conditions)
